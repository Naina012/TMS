...
const Pricing = () => {
    return (
        <section className="pricing">
            <h4 className="miniTitle text-center">Its user-friendliness and its flexibility make it a no-brainer to use.</h4>
            <div className="text-center">
                <h2 className="sectionTitle">Whether you're managing your next big project or digitalizing task management for your team's daily business, you need to know who’s doing what, when.It helps you manage tasks in a beautiful, customizable environment that perfectly adapts to your needs.</h2>
            </div>
            <Container>
