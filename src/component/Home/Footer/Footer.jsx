        ...
        <section className='row footer'>
            <Row className="col-md-11 mx-auto">
                ...
                <Col md={6} lg={3} className="fAboutUs">
                    ...
                    <p className="aboutUsDes">Say goodbye to lost sticky notes, chaotic email threads, and long status meetings.Get a clear overview of everything your team is working on – what’s already been done and what’s coming up next.</p>
